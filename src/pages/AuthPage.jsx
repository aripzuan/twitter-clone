...
export default function AuthPage() {
    const url = "https://c9ba7f53-46e6-4d63-b3f9-3943f9049c80-00-8846nsg8of01.sisko.replit.dev"
            ...
            <Col sm={6} className="p-4">
                ...
                <Col sm={5} className="d-grid gap-2">
                    ...
                    <p style={{fontSize: "12px"}}>
                        By signing up, you agree to the the Terms of Service and Privacy and Policy including Cookie Use
                    </p>
                ...
                <Modal show={modalShow !== null} onHide={handleClose} centered animation={false}>
                    <Modal.Body>
                        ...
                        <Form  className="d-grid gap-2 px-5" onSubmit={modalShow === "SignUp" ? handleSignUp : handleLogin}>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Control onChange={(e) => setUsername(e.target.value)} type="email" placeholder="Email" />
                            </Form.Group>
